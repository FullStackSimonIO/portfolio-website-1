      ...
      >
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
          ...
          <p className="text-gray-200 hidden md:block">
            This powerfull Webapplication was built with TypeScript, React,
            Next, TailwindCSS and Framer Motion. <br />
            It is dynamically rendered on the serverside for optimal SEO
            purposes.
          </p>
